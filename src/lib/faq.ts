...
export const faq: faqItems[] = [
  ...
  },
  {
    ...
    content: `Operating a profitable box truck business as a single owner requires prioritising high-paying, consistent loads from sources such as load boards, local delivery contracts, and dispatchers. Efficient route planning is essential to minimise empty miles and fuel costs, while regular truck maintenance helps prevent costly breakdowns. Partnering with a dedicated dispatcher can facilitate the expansion of specialised services, including expedited deliveries, moving assistance, niche cargo, and back-office mover management. Monitoring expenses closely and combining partial loads when feasible can further maximise revenue per trip.`,
  },
];