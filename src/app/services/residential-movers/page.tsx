        ...
        <div className="max-w-7xl mx-auto px-4 pt-6 sm:pt-6 md:pt-6 lg:pt-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10">
                <div className="flex-1">
                    <Image src="/condo-movers.jpg" alt="residential movers in Calgary" width={600} height={400} className="w-full rounded-xl shadow-md object-cover"/>
                </div>
                <div className="flex-1 space-y-4">
                    <h2 className="text-2xl md:text-3xl font-bold text-gray-900">Calgary's Trusted Residential Movers</h2>
                    <p className="text-gray-700 leading-relaxed font-bold"><i>Your Home Deserves More Than Just a Moving Truck</i></p>
                    <p className="text-gray-700 leading-relaxed">Apartment, Condo & House Relocations — Handled with Care, Every Single Time. Moving is one of the most significant events in a person's life — and we treat it that way. At Shiftrix, our residential movers in Calgary understand that behind every box is a memory, and behind every doorstep is a fresh beginning.</p>
                    <p className="text-gray-700 leading-relaxed">Whether you're leaving a downtown condo in Beltline, upgrading to a family home in Tuscany, or relocating within the same block in Kensington — our residential relocation services are built around you. Not around a clipboard. Not around a cookie-cutter process.</p>
                    <p className="text-gray-700 leading-relaxed">We show up prepared, we work efficiently, and we leave you feeling settled. That's the Shiftrix promise.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto text-center">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">We Move Every Type of Calgary Home</h2>
                <p className="text-gray-600">Calgary's residential landscape is wonderfully diverse — from high-rise condos on 17th Ave to spacious detached homes in Evanston. Each property type presents its own set of challenges, and our residential moving team is trained to handle them all.</p>
            </div>
            {/* Content Section */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 my-8">
                <div className="bg-gradient-to-br via-indigo-100 to-indigo-50 rounded-xl shadow space-y-2 p-6 sm:p-8">
                    ...
                    <p className="text-gray-700 leading-relaxed">Calgary high-rises, low-rises, and inner-city condos.</p>
                ...
                <div className="bg-gradient-to-br via-indigo-100 to-indigo-50 rounded-xl shadow space-y-2 p-6 sm:p-8">
                    ...
                    <p className="text-gray-700 leading-relaxed">Calgary's growing townhouse communities, inside and out.</p>
                    <ul className="list-disc list-inside text-gray-700 leading-relaxed">
                ...
                <div className="bg-gradient-to-br via-indigo-100 to-indigo-50 rounded-xl shadow space-y-2 p-6 sm:p-8">
                    ...
                    <p className="text-gray-700 leading-relaxed">From starter homes to large family estates across Calgary.</p>
                    <ul className="list-disc list-inside text-gray-700 leading-relaxed">
            ...
            <p className="text-gray-700 leading-relaxed">No matter where you live or where you're headed, Shiftrix provides residential moving services tailored to your property type — so you never have to worry about logistics on moving day.</p>              
        </div>
    </section>
    ...
    <section className="relative py-12">
        <div className="max-w-7xl mx-auto px-4 space-y-18">
            <div className="text-center">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">What to Do Before Your Residential Movers Arrive</h2>
                <p className="text-gray-700 mb-6 leading-relaxed">A little preparation goes a long way. Here's your room-by-room checklist to make your residential move in Calgary as smooth as possible:</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10">
                ...
                <div className="flex-1 space-y-4">
                    ...
                    <div className="flex items-start gap-4 px-3 py-2 bg-white rounded-xl shadow hover:shadow-md transition">
                        ...
                        <p className="text-sm text-gray-700"><strong>Confirm elevator booking (condos):</strong>  Contact your building manager at least 5 business days before moving day to reserve the elevator and freight lift. Most Calgary condo buildings require written notice.</p>
                    </div>

                    <div className="flex items-start gap-4 px-3 py-2 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-2 h-2 min-w-2 min-h-2 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-sm text-gray-700"><strong>Obtain parking permits:</strong>  Check with the City of Calgary if you need a temporary no-parking zone in front of your home. Some inner-city areas like Kensington and Mission require permits.</p>
                    </div>
                    
                    <div className="flex items-start gap-4 px-3 py-2 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-2 h-2 min-w-2 min-h-2 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-sm text-gray-700"><strong>Declutter & donate:</strong>  Moving is the perfect time to part with items you no longer need. The less you move, the more affordable and efficient your residential relocation will be.</p>
                    </div>
                    
                    <div className="flex items-start gap-4 px-3 py-2 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-2 h-2 min-w-2 min-h-2 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-sm text-gray-700"><strong>Pack an essentials box:</strong>  Keep a separate, clearly labelled box with everything you'll need in the first 24 hours — phone charger, toiletries, a change of clothes, snacks, and important documents.</p>
                    </div>
                    
                    <div className="flex items-start gap-4 px-3 py-2 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-2 h-2 min-w-2 min-h-2 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-sm text-gray-700"><strong>Defrost the fridge:</strong>  At least 24 hours before your move, empty and defrost your refrigerator to prevent water damage during transport.</p>
                    </div>

                </div>

                <div className="flex-1">
                    <Image src="/condo-movers-2.jpg" alt="Trusted residential moving services in Calgary for smooth relocation" width={600} height={400} className="w-full rounded-xl shadow-md object-cover"/>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10">
                ...
                <div className="order-2 md:order-1 flex-1">
                    <Image src="/apartment-mover-1.jpg" alt="residential relocation services for house to move in calgary" width={600} height={400} className="w-full rounded-xl shadow-md object-cover"/>
                </div>
                ...
                <div className="order-1 md:order-2 flex-1 space-y-4">
                    ...
                    <div className="flex items-start gap-4 px-3 py-2 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-2 h-2 min-w-2 min-h-2 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-sm text-gray-700"><strong>Label every box by room:</strong> Clear labels speed up unloading dramatically. Colour-coded labels by room work best — your movers will know exactly where each box belongs.</p>
                    </div>
                    
                    <div className="flex items-start gap-4 px-3 py-2 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-2 h-2 min-w-2 min-h-2 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-sm text-gray-700"><strong>Protect valuables & paperwork:</strong> Keep jewellery, passports, financial documents, and irreplaceable items with you during the move, not in the truck.</p>
                    </div>
                    
                    <div className="flex items-start gap-4 px-3 py-2 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-2 h-2 min-w-2 min-h-2 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-sm text-gray-700"><strong>Measure doorways & staircases:</strong> For large furniture pieces, confirm measurements in advance. Our team can advise on disassembly if needed — just let us know ahead of time.</p>
                    </div>
                    
                    <div className="flex items-start gap-4 px-3 py-2 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-2 h-2 min-w-2 min-h-2 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-sm text-gray-700"><strong>Notify your building of move-out:</strong> Give your current building management official written notice of your move-out date. Most Calgary landlords require 30–60 days.</p>
                    </div>
                    
                    <div className="flex items-start gap-4 px-3 py-2 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-2 h-2 min-w-2 min-h-2 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-sm text-gray-700"><strong>Confirm your moving window:</strong> Many Calgary condo buildings restrict moves to specific hours (e.g., 8 AM–6 PM). Verify your window so there are no surprises on moving day.</p>
                    </div>
