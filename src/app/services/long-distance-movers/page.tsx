  ...
  return (
    ...
    <section className="relative sm:pt-40 md:pt-40 lg:pt-40 pt-40 pb-12">
        <div className="max-w-7xl mx-auto px-4 pt-6 sm:pt-6 md:pt-6 lg:pt-6">
            <h1 className="text-3xl md:text-4xl font-bold pb-12 text-gray-900">Long Distance Movers</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10">
                <div className="flex-1">
                    <Image src="/long-distance-movers.jpg" alt="long distance movers" width={600} height={400} className="w-full rounded-xl shadow-md object-cover"/>
                </div>
                <div className="flex-1">
                    <h2 className="text-2xl md:text-3xl font-bold pb-6 text-gray-900">Long-distance Movers and Packers On A Budget</h2>
                    <p className="text-gray-700 leading-relaxed">Shiftrix provides affordable long-distance moving services for everyone who needs value without sacrificing quality. We handle your packing with care, load your belongings securely, and transport them safely anywhere in Canada at a price you can afford. Whether you need to move your entire home or just a few important things, our team works to make your move smooth and stress-free.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto text-center mb-12">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">Why Choose the Most Reliable Long-Distance Movers?</h2>
                <p className="text-gray-600">Shiftrix positions itself among the most reliable long distance movers by combining professional crews, modern trucks, and proven processes.​</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10">
                ...
                <div className="flex justify-center">
                    <Image src="/long-distance-movers-1.jpg" alt="best long distance movers" width={600} height={400} className="w-full rounded-2xl object-cover shadow-lg max-w-full h-auto"/>
                </div>

                {/* Right Content */}
                <div className="space-y-4">
                    <h3 className="text-xl font-semibold mb-4">Reasons to hire the best movers</h3>
                    <div className="flex items-start gap-4 px-3 py-2 bg-white rounded-xl shadow hover:shadow-md transition">
                        ...
                        <p className="text-sm text-gray-700">Reduced risk of damage through trained packing and handling.​​</p>
                    </div>

                    <div className="flex items-start gap-4 px-3 py-2 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-2 h-2 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-sm text-gray-700">Time savings with efficient planning, loading, and routing.​​</p>
                    </div>

                    <div className="flex items-start gap-4 px-3 py-2 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-2 h-2 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-sm text-gray-700">Lower stress thanks to clear communication and tracking options.​</p>
                    </div>
                    <div className="flex items-start gap-4 px-3 py-2 bg-white rounded-xl shadow hover:shadow-md transition">
                        <div className="w-2 h-2 bg-blue-600 mt-2 rounded-sm"></div>
                        <p className="text-sm text-gray-700">Better value from optimized routes and competitive, transparent pricing.​</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section className="relative py-12">
        <div className="max-w-7xl mx-auto px-4 space-y-18">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10">
                <div className="flex-1">
                    <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">Affordable One-Way Long-Distance Movers for Small Loads</h2>
                    <p className="text-gray-700 mb-6 leading-relaxed">Not every move fills a truck, so Shiftrix offers one way long distance movers options ideal for condos, students, and downsizing clients. Long distance movers for small loads can significantly reduce costs by consolidating shipments while still maintaining clear schedules and professional handling. These affordable long distance movers services are perfect when you only need to move a few rooms, seasonal items, or select furniture across provinces. Shiftrix structures these routes to keep prices low, making us a smart choice among budget long distance movers for one-way moves.​</p>
                </div>
                <div className="flex-1">
                    <Image src="/long-distance-movers-2.jpg" alt="affordable long distance movers" width={600} height={400} className="w-full rounded-xl shadow-md object-cover"/>
                </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10">
                <div className="order-2 md:order-1 flex-1">
                    <Image src="/long-distance-movers-3.jpg" alt="top long distance movers" width={600} height={400} className="w-full rounded-xl shadow-md object-cover"/>
                </div>
                <div className="order-1 md:order-2 flex-1">
                    <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">Experience with Full-Service Long-distance Movers</h2>
                    <p className="text-gray-700 mb-6 leading-relaxed">Full service long distance movers handle everything: packing, loading, transportation, unloading, and optional storage. Shiftrix mirrors leading providers by offering long distance movers and packers who bring materials, protect your furniture, and set items in place at your new home. This approach is ideal for busy professionals and families who want most reliable long distance movers capable of managing complex timelines, elevators, and multi-stop moves. With a single coordinated team, you avoid juggling multiple vendors or doing heavy lifting yourself.​</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section className="py-12 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center mb-12">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-3">Why Rely on Shiftrix?</h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
                {/* Item 1 */}
                <div className="bg-gray-100 rounded-2xl shadow p-6 sm:p-8 md:p-10 lg:p-12 hover:shadow-lg transition">
                    <div className="text-xl font-semibold text-indigo-600 mb-2">Transparent, budget-conscious pricing</div>
                    <p className="text-gray-700">Clear, upfront estimates tailored to your inventory and route so you can plan confidently with affordable long distance movers and avoid surprise charges.​</p>
                </div>

                {/* Item 2 */}
                <div className="bg-gray-100 rounded-2xl shadow p-6 sm:p-8 md:p-10 lg:p-12 hover:shadow-lg transition">
                    <div className="text-xl font-semibold text-indigo-600 mb-2">Flexible options for small and large loads</div>
                    <p className="text-gray-700">From long distance movers for small loads to full household relocations, services scale to your needs without wasting space or budget.</p>
                </div>

                {/* Item 3 */}
                <div className="bg-gray-100 rounded-2xl shadow p-6 sm:p-8 md:p-10 lg:p-12 hover:shadow-lg transition">
                    <div className="text-xl font-semibold text-indigo-600 mb-2">Professional packing and protection</div>
                    <p className="text-gray-700">Trained long distance movers and packers use proven techniques and quality materials to safeguard furniture, electronics, and fragile items in transit.​</p>
                </div>

                {/* Item 4 */}
                <div className="bg-gray-100 rounded-2xl shadow p-6 sm:p-8 md:p-10 lg:p-12 hover:shadow-lg transition">
                    <div className="text-xl font-semibold text-indigo-600 mb-2">Reliable scheduling and communication</div>
                    <p className="text-gray-700">As one of the most reliable long distance movers, Shiftrix focuses on on-time delivery, route planning, and proactive updates throughout your move.​</p>
                </div>
            </div>
        </div>
    </section>
