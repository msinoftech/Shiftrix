      ...
      <div className="text-white bg-gradient-to-br from-indigo-800 to-indigo-500">
        <div className="max-w-7xl mx-auto px-4 py-2">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4">
            <div className="flex sm:items-center justify-center gap-2 sm:gap-5">
              <Link href={phoneHref} aria-label="Phone Number" className="inline-flex items-center gap-1 justify-center sm:justify-start text-[13px] sm:text-sm">
              ...
              <Link href={emailHref} aria-label="Email Address" className="inline-flex items-center gap-1 justify-center sm:justify-start text-[13px] sm:text-sm">
