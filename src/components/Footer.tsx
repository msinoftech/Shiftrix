          ...
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li className="flex items-center">
                ...
                <Link href={emailHref} aria-label="Email Address" className="hover:text-indigo-800 transition">{email}</Link>
              </li>
              <li className="flex items-center">
                ...
                <Link href={phoneHref} aria-label="Phone Number" className="hover:text-indigo-800 transition">{phone}</Link>
              </li>
            </ul>
